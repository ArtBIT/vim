...
snoremap  "_c
nmap gV <Plug>VMSRITabJump
nmap gv <Plug>VMSRITabOnly
nmap V <Plug>VMSRISplitJump
nmap v <Plug>VMSRISplitOnly
nnoremap ,d :YcmShowDetailedDiagnostic
xmap ,a: :Tabularize /:\zs
nmap ,a: :Tabularize /:\zs
xmap ,a= :Tabularize /=
nmap ,a= :Tabularize /=
nnoremap <silent> ,p :call pdv#DocumentWithSnip()
nnoremap ,u :GundoToggle
nnoremap <silent> ,b :CtrlPBuffer
nnoremap <silent> ,t :CtrlPMRU
nnoremap <silent> ,n :set hlsearch! hlsearch?
xnoremap <silent> ,n :set hlsearch! hlsearch?
onoremap <silent> ,n :set hlsearch! hlsearch?
nmap <silent> ,h :set nolist!
...
nmap gV <Plug>VMSRIEditJump
nmap gv <Plug>VMSRIEditOnly
...
nmap <C-Down> ]e
nmap <C-Up> [e
nnoremap <silent> <F2> :wa|exe "mksession! $VIMS/last.vim"
...
set guicursor=n-v-c:block-Cursor/lCursor,ve:ver35-Cursor,o:hor50-Cursor,i-ci:ver25-Cursor/lCursor,r-cr:hor20-Cursor/lCursor,sm:block-Cursor-blinkwait175-blinkoff150-blinkon175,n-c:blinkwait800-iCursor,i-v:ver10-Cursor,r:hor10-Cursor,ci:ver10-iCursor,cr:hor10-iCursor,sm:iCursor,o:hor50-Error
set helplang=en
set hidden
set hlsearch
set incsearch
...
set smarttab
set softtabstop=4
set statusline=[%c,%l]\ %t%h%m%r%=[%b\ 0x%02B]\ %P
...
silent only
cd /www/deviantart.com
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 styles/jms/pages/account_recovery.js
badd +0 ~/.vim/bundle/vim-tmpl/plugin/tmpl.vim
args styles/jms/pages/account_recovery.js
edit styles/jms/pages/account_recovery.js
...
3
normal! 0
tabedit ~/.vim/bundle/vim-tmpl/plugin/tmpl.vim
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
